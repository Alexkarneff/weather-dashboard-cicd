...
# os.environ.get('OPENWEATHER_API_KEY') récupère la clé API depuis les variables d’environnement. C’est GitHub Actions qui injectera cette variable à partir des secrets. Ainsi, la clé n’apparaît jamais dans le code